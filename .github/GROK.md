...
```
Read `.github/GROK.md` on the `gh-pages` branch of https://github.com/bridgetownpartners/ROIClear and use it as project memory before making changes.

Repo: https://github.com/bridgetownpartners/ROIClear
Live site: https://ROIClear.com

Pull fresh files before recommending full-file replacements.
